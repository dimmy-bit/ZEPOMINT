// scripts/deploy-smart-finalize.js
// Deployment script for smart finalize contract
...
async function main() {
  ...
  try {
    ...
    const deploymentFilePath = path.join(__dirname, "..", "deployments", "zepamint-smart-finalize-deployment.json");
