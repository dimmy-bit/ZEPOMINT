...
async function main() {
  ...
  console.log("=== ZepoMINT FHE Auction Force Finalization ===");
  ...
  try {
    console.log("Force finalizing auction...");
    ...
    // Try to finalize the auction with a specific gas limit
    console.log("Sending transaction to finalize auction with fixed gas limit...");
    
    // Send transaction with a fixed gas limit to bypass gas estimation
