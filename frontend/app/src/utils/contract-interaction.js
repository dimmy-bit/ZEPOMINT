...
let CONTRACT_ADDRESS = import.meta.env.VITE_CONTRACT_ADDRESS || "0x5FC8d32690cc91D4c39d9d3abcBD16989F875707";
...
export async function computeWinner(signer) {
  try {
    ...
    const tx = await contract.smartFinalize({
      gasLimit: 10000000 // Reduced gas limit to stay under network cap
    });
