...
const RelayerTestComponent = () => {
  ...
  const testRelayerSDK = async () => {
    ...
    try {
      ...
      // Test creating an instance with environment variables
      const config = {
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            {testResults.success && (
              <div className="mt-4">
                ...
                <p className="font-mono text-sm break-all bg-gray-100 p-2 rounded mt-2">{testResults.publicKey}</p>
                
                <h3 className="font-medium mt-4">Instance Methods:</h3>
