// scripts/test-smart-finalize-direct.js
// Script to test the smartFinalize function directly

require('dotenv').config();
const { ethers } = require('ethers');

async function main() {
  console.log("=== TESTING SMART FINALIZE FUNCTION ===");
