...
// Script to update the frontend configuration with the new contract address
...
async function main() {
  ...
  const deploymentPath = path.join(__dirname, "..", "deployments", "fixed-contract-deployment.json");
